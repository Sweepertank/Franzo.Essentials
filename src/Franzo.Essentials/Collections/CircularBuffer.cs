...
public class CircularBuffer<T> : IReadOnlyList<T>
{
    ...
    /// <summary>
    /// The _count. Number of elements in the buffer.
    /// </summary>
    private int _count;
    ...
    /// valid interval is [0;Count[
    /// </summary>
    /// <param name="index">Index of element to access.</param>
    /// <exception cref="IndexOutOfRangeException">Thrown when index is outside of [; Count[ interval.</exception>
    public T this[int index]
    {
        get
        {
            ...
            if (index >= _count)
            {
                throw new IndexOutOfRangeException(string.Format("Cannot access index {0}. Buffer count is {1}", index, _count));
            }
    ...
    /// <summary>
    /// Clears the contents of the array. Count = 0, Capacity is unchanged.
    /// </summary>
